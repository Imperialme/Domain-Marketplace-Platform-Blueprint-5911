    ...
    <div style={{padding:14,display:"flex",flexDirection:"column",gap:10}}>
      ...
      {tab==="market"&&<>
        ...
        <div style={{overflowX:"auto"}}><div style={{display:"flex",gap:5,paddingBottom:3,width:"max-content"}}>
          {[{v:"analyst",l:"By Rating"},{v:"div_hi",l:"Div ↓"},{v:"div_lo",l:"Div ↑"},{v:"price_hi",l:"Price ↓"},{v:"price_lo",l:"Price ↑"},{v:"gain",l:"Gainers"},{v:"loss",l:"Losers"}].map(s=><button key={s.v} onClick={()=>setSort(s.v)} style={{padding:"5px 10px",borderRadius:20,border:"1px solid "+(sort===s.v?"#16A34A":"#334155"),background:sort===s.v?"#14532D":"#1E293B",color:sort===s.v?"#86EFAC":"#94A3B8",fontWeight:600,fontSize:10,cursor:"pointer",whiteSpace:"nowrap"}}>{s.l}</button>)}
        </div></div>
        {/* Filter by rating */}
        <div style={{overflowX:"auto"}}><div style={{display:"flex",gap:5,paddingBottom:3,width:"max-content"}}>
