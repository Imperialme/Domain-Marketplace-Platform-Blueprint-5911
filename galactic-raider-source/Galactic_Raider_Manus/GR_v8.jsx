...
// ── STATIC DATA ────────────────────────────────────────────────
const COS=[
  {t:"SLKT",n:"Silk Road Tech",s:"Technology",r:"Asia Pacific",ip:348.94,pe0:18.4,div:0.8,b:1.8,yr:2008,emp:125000,hq:"Singapore",ceo:"Dr. Lin Wei",founder:"Dr. Lin Wei — sold his apartment to fund first prototype",story:"Stanford-trained engineer from Guangzhou. Grew from 4 staff in a Singapore shophouse to 125,000-person empire spanning 18 markets.",ops:"Enterprise cloud, AI inference chips, cross-border data. Singapore, Tokyo, Seoul, Mumbai, Sydney.",analyst:"BUY",target:420,desc:"AI and cloud leader across 18 Asia Pacific markets."},
  {t:"MRDB",n:"Meridian Bank",s:"Banking",r:"US",ip:85.20,pe0:12.1,div:2.1,b:0.9,yr:1985,emp:45000,hq:"New York",ceo:"Patricia Hernandez",founder:"James R. Meridian — started as a teller in Brooklyn 1972",story:"First-gen Irish-American who built from a single Brooklyn branch. Went public 1985, expanded through 14 acquisitions.",ops:"2,400 US branches. Corporate lending, wealth management, mortgages.",analyst:"HOLD",target:90,desc:"Mid-size US commercial bank with strong Midwest footprint."},
  {t:"FRMN",n:"Frontier Mining",s:"Mining",r:"Africa",ip:15.80,pe0:8.5,div:0.5,b:1.6,yr:2005,emp:28000,hq:"Johannesburg",ceo:"Amara Diallo",founder:"Kwame Asante — Ghanaian geologist who discovered rare earths in rural Ghana",story:"Bootstrapped with local govt support. Now operates across 9 African nations supplying Asian battery makers.",ops:"Iron ore in Mauritania, lithium in Zimbabwe, rare earths in DRC.",analyst:"BUY",target:22,desc:"Pan-African critical minerals group powering the EV revolution."},
  {t:"TNPT",n:"Titan Petroleum",s:"Energy",r:"Emerging Markets",ip:351.54,pe0:11.3,div:1.8,b:1.2,yr:1995,emp:62000,hq:"Dubai",ceo:"Sheikh Rashid Al-Mansouri",founder:"Al-Mansouri family of Abu Dhabi",story:"Started as private trading company 1995. Listed DFM 2003. Expanded via Gulf concessions and Central Asian pipeline deals.",ops:"Crude in UAE, Kuwait, Oman. Pipeline across Kazakhstan. Refinery in Oman.",analyst:"HOLD",target:360,desc:"Third-largest Gulf petroleum producer. Vertically integrated from extraction to export."},
  {t:"AGRO",n:"AgroLatin Corp",s:"Agriculture",r:"Latin America",ip:42.18,pe0:13.2,div:2.5,b:1.1,yr:1975,emp:18000,hq:"São Paulo",ceo:"Isabella Sousa",founder:"Carlos Sousa — started on family farm in Mato Grosso 1975",story:"Third generation Sousa now leads. Expanded through land acquisition during Brazil's ag boom.",ops:"4.2M hectares in Brazil and Argentina. Soy, corn, sugarcane, cattle. 22 export markets.",analyst:"BUY",target:52,desc:"Largest agri-business in Latin America by farmland. Consistent dividend payer."},
  {t:"MDCR",n:"MediCore Group",s:"Healthcare",r:"US",ip:198.40,pe0:22.1,div:1.2,b:0.8,yr:2005,emp:38000,hq:"Boston",ceo:"Dr. Sarah Chen",founder:"Dr. Marcus Webb — Harvard oncologist who licensed tumour-targeting patent 2005",story:"Built from IP licensing into full hospital management and medical devices.",ops:"180 hospitals, 400 diagnostic labs in North America. 3 oncology drugs in FDA Phase 3.",analyst:"STRONG BUY",target:240,desc:"Premium healthcare group with proprietary oncology technology."},
  {t:"CLFL",n:"ClearFlame Energy",s:"Energy",r:"Europe",ip:112.30,pe0:14.8,div:2.0,b:1.1,yr:2010,emp:22000,hq:"Amsterdam",ceo:"Hans Brouwer",founder:"Dr. Marta Kowalski — Polish engineer who left Shell 2010",story:"Pioneered hybrid wind-gas grid technology. IPO'd on Euronext 2016 at €28.",ops:"North Sea wind, Iberian solar, German gas peaking plants. 12M household customers.",analyst:"BUY",target:130,desc:"European diversified energy leader. Carbon-neutral target 2027."},
  {t:"AXMB",n:"Axum Biotech",s:"Healthcare",r:"Africa",ip:68.50,pe0:19.4,div:0.6,b:1.4,yr:2012,emp:8500,hq:"Addis Ababa",ceo:"Dr. Yohannes Tesfaye",founder:"Dr. Tesfaye — Ethiopian physician rejected by Western pharma",story:"Backed by African Union and Gates Foundation. First African biotech to achieve WHO pre-qualification.",ops:"Vaccine manufacturing Ethiopia and Kenya. 8 genomic labs across Africa. Malaria vaccine Phase 3.",analyst:"SPECULATIVE BUY",target:85,desc:"High-risk high-reward African biotech. Phase 3 trial is the catalyst."},
  {t:"PCMN",n:"Pacific Mfg",s:"Manufacturing",r:"Asia Pacific",ip:76.20,pe0:15.6,div:1.3,b:1.0,yr:1988,emp:55000,hq:"Seoul",ceo:"Park Joon-ho",founder:"Park Dae-jung — retired Korean army engineer, started with $50K loan 1988",story:"Started making circuit boards for Samsung. Now supplies 14 of top 20 global car manufacturers.",ops:"Plants in Korea, Vietnam, Mexico, Poland. JIT supply chain for auto OEMs.",analyst:"HOLD",target:80,desc:"Solid EV battery parts maker. OEM margin pressure is the main risk."},
  {t:"NRDX",n:"Nordic Bank",s:"Banking",r:"Europe",ip:132.10,pe0:11.8,div:2.4,b:0.8,yr:1975,emp:32000,hq:"Stockholm",ceo:"Astrid Lindqvist",founder:"Swedish government banking consortium 1975",story:"Privatised 1992. Expanded through Nordic acquisitions. Conservative, reliable lender.",ops:"Retail, wealth and institutional banking across 18 European countries.",analyst:"BUY",target:150,desc:"Best-in-class Nordic banking franchise. Low NPLs, reliable dividend."},
  {t:"UTLS",n:"Utility Systems",s:"Utilities",r:"US",ip:58.40,pe0:14.2,div:4.2,b:0.5,yr:1950,emp:12000,hq:"Chicago",ceo:"Robert Keller",founder:"Chicago City Council 1950",story:"Privatised 1987. Regulated monopoly — rate increases state-approved and reliably granted.",ops:"Electric grid 1.9M customers. Gas 1.3M customers. 3 nuclear plants, 2 coal retiring 2028.",analyst:"HOLD",target:60,desc:"Classic defensive utility. 4.2% dividend yield is the attraction. Limited growth."},
  {t:"TLCM",n:"TeleCom Europe",s:"Telecom",r:"Europe",ip:88.60,pe0:13.5,div:4.5,b:0.6,yr:1985,emp:48000,hq:"Frankfurt",ceo:"Klaus Hoffman",founder:"West German government postal privatisation 1985",story:"Grew pan-European through 22 acquisitions. Now largest mobile operator in Europe.",ops:"Mobile, broadband, enterprise across 22 countries. 280M subscribers. Largest EU 5G network.",analyst:"HOLD",target:92,desc:"Mature telecom with high dividend. 5G rollout nearly complete."},
  {t:"RETL",n:"RetailHub Inc",s:"Retail",r:"US",ip:38.90,pe0:14.0,div:1.5,b:1.2,yr:2000,emp:85000,hq:"Seattle",ceo:"Amanda Torres",founder:"David Park — Korean-American logistics entrepreneur 2000",story:"Built physical retail around loyalty programme before e-commerce was mainstream.",ops:"1,200 stores across 35 US states. 48M loyalty members. AI inventory management.",analyst:"SELL",target:35,desc:"Structural pressure from Amazon and Walmart. Loyalty programme is the only moat."},
  {t:"RLST",n:"RealEstate Trust",s:"Real Estate",r:"US",ip:44.20,pe0:12.8,div:3.8,b:0.7,yr:1995,emp:2800,hq:"Dallas",ceo:"Michael Johnson",founder:"Texas pension fund consortium 1995",story:"Listed NYSE 1998. Pivoted to logistics warehouses 2018 — decision that tripled NAV.",ops:"$18B portfolio. 40% logistics, 35% industrial, 25% office. Sun Belt focus.",analyst:"BUY",target:52,desc:"Best-positioned REIT for e-commerce logistics growth."},
  {t:"EMTS",n:"Emerging Tech",s:"Technology",r:"Emerging Markets",ip:28.40,pe0:22.0,div:0.2,b:2.0,yr:2015,emp:6500,hq:"Mumbai",ceo:"Priya Patel",founder:"Priya Patel — Bangalore-born MIT grad, Sequoia India Series A 2016",story:"Returned to India to build enterprise cloud for South Asian SMEs. 35% annual growth.",ops:"B2B SaaS for 18,000 clients across South Asia.",analyst:"STRONG BUY",target:40,desc:"High-growth EM tech play. Massive addressable market, founder-led, profitable."},
];
...
export default function App(){
  ...
  if(!S.current){
    S.current={
      turn:1,personalWallet:100000,tradingWallet:900000,gsfWallet:0,walletPending:0,gdp:2.5,inf:3.2,intr:4.5,gsf:12.48,
  ...
  const advance=useCallback(()=>{
    ...
    if((s.gsfWallet||0)>0){
      const ret=Math.round((s.gsfWallet||0)*(s.gsf/100/365)*100)/100;
      s.tradingWallet=Math.round((s.tradingWallet+ret)*100)/100;
    ...
    if(s.turn%10===0){
      ...
      if(coup>0){
        s.tradingWallet=Math.round((s.tradingWallet+coup)*100)/100;
        s.lastCoup=coup;
    ...
    if(nwNow>10e9){const tx=Math.round((nwNow-10e9)*.001*100)/100;s.tradingWallet=Math.max(0,s.tradingWallet-tx);}
    // Milestones
  ...
  const nw=(d.tradingWallet||0)+sv+bv+cv+crv+(d.gsfDep||0);
  ...
  const execTrade=(type,item,mode,qty)=>{
    ...
    if(type==="stock"){
      if(isBuy){
        ...
        if(cost>s.tradingWallet){toast_("Need "+fm(cost)+" — have "+fm(s.tradingWallet),false);return;}
      ...
      if(isBuy){
        ...
        s.tradingWallet=Math.round((s.tradingWallet+proc)*100)/100;
  ...
  const S_Dash=<div style={{padding:14,display:"flex",flexDirection:"column",gap:12}}>
    ...
    <div style={{background:"linear-gradient(135deg,#1B5E20,#2E7D32)",borderRadius:18,padding:20,color:"#fff",overflow:"hidden",position:"relative"}}>
      ...
      <div style={{display:"flex",gap:8,marginTop:12,paddingTop:12,borderTop:"1px solid rgba(255,255,255,.2)"}}>
        {[["Cash",fm((d.tradingWallet||0))],["Stocks",fm(sv)],["Bonds",fm(bv)],["Comm.",fm(cv)],["Crypto",fm(crv)],["GSF",fm(d.gsfDep||0)]].map(([k,v])=><div key={k} style={{flex:1,textAlign:"center"}}><div style={{fontSize:8,opacity:.5,textTransform:"uppercase"}}>{k}</div><div style={{fontSize:10,fontWeight:700,fontFamily:"monospace",marginTop:2}}>{v}</div></div>)}
      </div>
    </div>
    {/* Controls */}
  ...
  const S_Fx=(()=>{
    const FXP=d.fxPos||{},tw=d.tradingWallet||0;
    const pcts=[5,10,25,50,100];
    return <div style={{padding:14,display:"flex",flexDirection:"column",gap:10}}>
      <div style={{background:"#E3F2FD",borderRadius:11,padding:12,border:"1px solid #BBDEFB",fontSize:12,color:BL}}>
        Long = profit if price rises · Short = profit if falls · No limits — use any % of Trading Wallet · USD/AED and USD/CNY locked
      </div>
      {Object.keys(FXP).length>0&&<div style={{background:"#fff",borderRadius:12,border:"1px solid #e8ebe8",padding:14}}>
        <div style={{fontSize:13,fontWeight:700,color:DK,marginBottom:10}}>📂 Open Positions</div>
        {Object.entries(FXP).map(([id,pos])=>{
          const fx2=d.fx.find(f=>f.id===id);if(!fx2)return null;
          const pnl=pos.side==="long"?(fx2.p-pos.entry)*pos.cost/pos.entry:(pos.entry-fx2.p)*pos.cost/pos.entry;
          return <div key={id} style={{marginBottom:10}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
              <div><span style={{fontSize:13,fontWeight:700}}>{id}</span> <span style={{fontSize:11,fontWeight:700,color:pos.side==="long"?G:R}}>{pos.side.toUpperCase()}</span><div style={{fontSize:11,color:"#aaa"}}>Entry {pos.entry.toFixed(4)} · Now {fx2.p.toFixed(4)} · {fm(pos.cost)} in</div></div>
              <div style={{textAlign:"right"}}><div style={{fontSize:16,fontWeight:800,fontFamily:"monospace",color:pnl>=0?G:R}}>{pnl>=0?"+":""}{fm(pnl)}</div><div style={{fontSize:10,color:"#aaa"}}>{pnl>=0?"Profit":"Loss"}</div></div>
            </div>
            <button onClick={()=>{const s=S.current,p2=s.fxPos[id];const pl2=p2.side==="long"?(fx2.p-p2.entry)*p2.cost/p2.entry:(p2.entry-fx2.p)*p2.cost/p2.entry;s.tradingWallet=Math.round(((s.tradingWallet||0)+p2.cost+pl2)*100)/100;delete s.fxPos[id];toast_("Closed "+id+" · P&L: "+(pl2>=0?"+":"")+fm(pl2));refresh();}} style={{width:"100%",background:pnl>=0?G:R,color:"#fff",border:"none",borderRadius:9,padding:"10px 0",fontWeight:800,fontSize:13,cursor:"pointer"}}>Close Position · P&L {pnl>=0?"+":""}{fm(pnl)}</button>
          </div>;
        })}
      </div>}
      <div style={{background:"#fff",borderRadius:12,border:"1px solid #e8ebe8",overflow:"hidden"}}>
        {d.fx.map((fx,i)=><div key={fx.id}>
          <div onClick={()=>!fx.locked&&!FXP[fx.id]&&setFxSel(fxSel===fx.id?null:fx.id)} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 14px",borderBottom:fxSel===fx.id?"none":"1px solid #f5f5f5",cursor:fx.locked||FXP[fx.id]?"default":"pointer",background:fxSel===fx.id?"#F0F7FF":"#fff"}}>
            <div><div style={{fontSize:13,fontWeight:700,color:DK}}>{fx.n}</div><div style={{fontSize:10,color:fx.locked?"#ccc":FXP[fx.id]?"#E65100":BL,fontWeight:600}}>{fx.locked?"Locked":FXP[fx.id]?"Position open":"Tap to trade"}</div></div>
            <div style={{textAlign:"right"}}><div style={{fontSize:14,fontWeight:800,fontFamily:"monospace",color:fx.locked?"#aaa":(fx.ch||0)>=0?G:R}}>{fx.p.toFixed(4)}</div>{!fx.locked&&<Bdg v={fx.ch||0}/>}</div>
          </div>
          {fxSel===fx.id&&!fx.locked&&!FXP[fx.id]&&<div style={{padding:"12px 14px",background:"#F8FBFF",borderBottom:"1px solid #e8ebe8"}}>
            <div style={{display:"flex",background:"#f0f4f0",borderRadius:9,padding:3,gap:2,marginBottom:10}}>
              {[{v:"long",l:"📈 Long — profit if rises"},{v:"short",l:"📉 Short — profit if falls"}].map(o=><button key={o.v} onClick={()=>{setFxSide(o.v);setFxAmtI(null);}} style={{flex:1,padding:"8px 0",borderRadius:8,border:"none",background:fxSide===o.v?"#fff":"transparent",color:fxSide===o.v?DK:"#999",fontWeight:700,fontSize:11,cursor:"pointer",boxShadow:fxSide===o.v?"0 1px 3px rgba(0,0,0,.1)":"none"}}>{o.l}</button>)}
            </div>
            <div style={{fontSize:11,color:"#888",marginBottom:8}}>Trading Wallet: {fm(tw)} · Pick % below — no limits</div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:6,marginBottom:10}}>
              {pcts.map(p=>{const amt=Math.round(tw*(p/100)/100)*100;return <button key={p} onClick={()=>setFxAmtI(amt)} style={{padding:"10px 4px",borderRadius:9,border:"2px solid "+(fxAmtI===amt?(fxSide==="long"?G:R):"#e0e0e0"),background:fxAmtI===amt?(fxSide==="long"?"#E8F5E9":"#FFEBEE"):"#fafafa",color:fxAmtI===amt?(fxSide==="long"?G:R):"#555",fontWeight:800,fontSize:11,cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",gap:1}}>
                <span>{p}%</span><span style={{fontSize:9}}>{fm(amt)}</span>
              </button>;})}
            </div>
            {fxAmtI>0&&<div style={{background:"#fff",borderRadius:9,padding:10,marginBottom:10,border:"1px solid #e0e0e0",display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
              <SB l="Position" v={fm(fxAmtI)} c={fxSide==="long"?G:R}/>
              <SB l="Direction" v={fxSide.toUpperCase()} c={fxSide==="long"?G:R}/>
              <SB l="+1% P&L" v={"+"+fm(fxAmtI*0.01)} c={G}/>
              <SB l="-1% P&L" v={fm(-fxAmtI*0.01)} c={R}/>
            </div>}
            <button onClick={()=>{
              if(!fxAmtI||fxAmtI<=0){toast_("Select % above",false);return;}
              const s=S.current;
              if(fxAmtI>(s.tradingWallet||0)){toast_("Need "+fm(fxAmtI)+" — Trading Wallet: "+fm(s.tradingWallet||0),false);return;}
            ...
            }} style={{width:"100%",background:fxAmtI>0?(fxSide==="long"?G:R):"#e0e0e0",color:"#fff",border:"none",borderRadius:10,padding:"12px 0",fontWeight:800,fontSize:13,cursor:"pointer"}}>
              {fxAmtI>0?"Open "+fxSide.toUpperCase()+" "+fm(fxAmtI)+" on "+fx.id:"Select % above"}
            </button>
          </div>}
        </div>)}
      </div>
  ...
  const S_Port=(()=>{
    ...
    return <div style={{padding:14,display:"flex",flexDirection:"column",gap:12}}>
      <div style={{background:"linear-gradient(135deg,#1B5E20,#388E3C)",borderRadius:16,padding:16,color:"#fff"}}>
        ...
        <div style={{fontSize:11,opacity:.75,marginTop:3}}>S:{fm(sv)} · B:{fm(bv)} · C:{fm(cv)} · Cr:{fm(crv)} · GSF:{fm(d.gsfDep||0)} · Cash:{fm((d.tradingWallet||0))}</div>
      </div>
  ...
  const S_GSF=<div style={{padding:14,display:"flex",flexDirection:"column",gap:12}}>
    ...
    <div style={{background:"#E3F2FD",borderRadius:13,padding:14,border:"1px solid #BBDEFB"}}>
      ...
      <div style={{display:"flex",gap:8,marginBottom:12}}>
        <SB l="Your Deposit" v={fm(d.gsfWallet||0)} c={BL}/>
      ...
      <div style={{background:"#fff",borderRadius:8,padding:"10px 12px",marginBottom:12,fontSize:12,color:"#666",lineHeight:1.6}}>
        ...
        Return calc: {fm(d.gsfWallet||0)} × {(d.gsf||12.48).toFixed(2)}% ÷ 365 turns = {fm((d.gsfDep||0)*((d.gsf||12.48)/100/365))}/turn<br/>
      ...
      <div style={{display:"flex",gap:8}}>
        ...
        {(d.gsfDep||0)>0&&<button onClick={()=>{const s=S.current;const amt=s.gsfDep;s.tradingWallet=Math.round((s.tradingWallet+amt)*100)/100;s.gsfDep=0;s.news.unshift({id:Math.random(),t:s.turn,ico:"🏛️",ti:"GSF Withdrawal",bo:fm(amt)+" withdrawn to cash.",g:true});toast_("Withdrawn "+fm(amt)+" from GSF");refresh();}} style={{flex:1,background:"#FFEBEE",color:R,border:"1px solid #EF9A9A",borderRadius:10,padding:"12px 0",fontWeight:700,fontSize:13,cursor:"pointer"}}>Withdraw All</button>}
      </div>
    </div>
  </div>;
  ...
  const S_Set=<div style={{padding:14,display:"flex",flexDirection:"column",gap:12}}>
    <div style={{background:"#fff",borderRadius:13,padding:14,border:"1px solid #e8ebe8"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}><SB l="Net Worth" v={fm(nw)} c={G}/><SB l="Cash" v={fm((d.tradingWallet||0))}/><SB l="Stock Value" v={fm(sv)} c={G}/><SB l="GSF Deposit" v={fm(d.gsfWallet||0)} c={BL}/><SB l="Events" v={d.aevts.length} c={d.aevts.length>0?AU:G}/><SB l="Eff. CGT" v={(20*(1-(d.taxRed||0))).toFixed(0)+"%"} c={G}/></div>
    </div>
    <div style={{background:"#fff",borderRadius:13,padding:14,border:"1px solid #e8ebe8"}}>
  ...
  const TrModal=(()=>{
    ...
    return <div style={{background:"#fff",borderRadius:"20px 20px 0 0",padding:20,width:"100%",maxHeight:"88vh",overflowY:"auto"}}>
      ...
      <div style={{background:isBuy?"linear-gradient(135deg,#1B5E20,#2E7D32)":"linear-gradient(135deg,#7B1515,#B71C1C)",borderRadius:14,padding:15,color:"#fff",marginBottom:14}}>
        ...
        <div style={{fontSize:12,opacity:.85,marginTop:3}}>{fm(price)} per {unit} · {isBuy?fm((d.tradingWallet||0))+" available · can buy "+maxQty.toLocaleString()+" "+unit:held.toLocaleString()+" "+unit+" held"}</div>
      </div>
  ...
  return <div style={{maxWidth:430,margin:"0 auto",background:"#F0F4F0",minHeight:"100vh",display:"flex",flexDirection:"column",fontFamily:"system-ui,-apple-system,sans-serif"}}>
    ...
    {donM&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.65)",zIndex:300,display:"flex",alignItems:"flex-end"}} onClick={e=>e.target===e.currentTarget&&setDonM(null)}>
      <div style={{background:"#fff",borderRadius:"20px 20px 0 0",padding:20,width:"100%"}}>
        ...
        <div style={{fontSize:12,color:"#888",marginBottom:5}}>Cash: {fm((d.tradingWallet||0))} · Each donation = CGT −5% on profit (max 25%)</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:7,marginBottom:12}}>
          {[1000,5000,10000,50000,100000,500000,1000000,Math.min(Math.floor((d.tradingWallet||0)/1000)*1000,(d.tradingWallet||0))].filter((v,i,a)=>v<=(d.tradingWallet||0)&&v>0&&a.indexOf(v)===i).slice(-8).map(v=><button key={v} onClick={()=>setDonAmt(v)} style={{padding:"11px 4px",borderRadius:10,border:"2px solid "+(donAmt===v?"#880E4F":"#e0e0e0"),background:donAmt===v?"#FCE4EC":"#fafafa",color:donAmt===v?"#880E4F":"#555",fontWeight:700,fontSize:11,cursor:"pointer"}}>{fm(v)}</button>)}
        </div>
        ...
        <button onClick={()=>{
          ...
          if(donAmt>(d.tradingWallet||0)){toast_("Insufficient cash",false);return;}
          const s=S.current;
    ...
    {gsfM&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.65)",zIndex:300,display:"flex",alignItems:"flex-end"}} onClick={e=>e.target===e.currentTarget&&setGsfM(false)}>
      <div style={{background:"#fff",borderRadius:"20px 20px 0 0",padding:20,width:"100%"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:7,marginBottom:12}}>
          {[1000,5000,10000,50000,100000,500000,1000000,Math.min(Math.floor((d.tradingWallet||0)/1000)*1000,(d.tradingWallet||0))].filter((v,i,a)=>v<=(d.tradingWallet||0)&&v>0&&a.indexOf(v)===i).slice(-8).map(v=><button key={v} onClick={()=>setGsfAmt(v)} style={{padding:"11px 4px",borderRadius:10,border:"2px solid "+(gsfAmt===v?BL:"#e0e0e0"),background:gsfAmt===v?"#E3F2FD":"#fafafa",color:gsfAmt===v?BL:"#555",fontWeight:700,fontSize:11,cursor:"pointer"}}>{fm(v)}</button>)}
        </div>
