...
export const EARTH_COMPANIES = [
  { t:'SLKT', n:'Silk Road Tech',    s:'Technology',    ip:348.94, pe0:18.4, div:.8,  b:1.8, yr:2008, emp:125000, hq:'Singapore',
    ...
    analysts:[{firm:'Goldman Sachs',rating:'STRONG BUY',target:420,note:'Dominant AI infrastructure play. Cloud margins expanding 200bps annually.'},{firm:'Morgan Stanley',rating:'BUY',target:395,note:'Asia Pacific cloud penetration still only 34%. Massive runway.'},{firm:'Bernstein',rating:'HOLD',target:360,note:'Great company, fair price. Would add on any pullback below $320.'},{firm:'Citi',rating:'SELL',target:290,note:'P/E of 18× unjustified given slowing revenue growth.'}],
  ...
  { t:'MRDB', n:'Meridian Bank',      s:'Banking',       ip:85.20,  pe0:12.1, div:2.1, b:.9,  yr:1985, emp:45000,  hq:'New York',
    ...
    analysts:[{firm:'Wells Fargo',rating:'BUY',target:95,note:'NIM expansion in rising rate environment. 2.1% dividend is reliable.'},{firm:'Barclays',rating:'HOLD',target:86,note:'In-line with sector. Neutral.'}],
  ...
  { t:'FRMN', n:'Frontier Mining',    s:'Mining',        ip:15.80,  pe0:8.5,  div:.5,  b:1.6, yr:2005, emp:28000,  hq:'Johannesburg',
    ...
    analysts:[{firm:'Standard Bank',rating:'BUY',target:22,note:'Lithium reserve base severely undervalued. EV demand structural.'},{firm:'Investec',rating:'HOLD',target:17,note:'Good company but commodity cycle risk is real.'}],
  ...
  { t:'TNPT', n:'Titan Petroleum',    s:'Energy',        ip:351.54, pe0:11.3, div:1.8, b:1.2, yr:1995, emp:62000,  hq:'Dubai',
    ...
    analysts:[{firm:'Emirates NBD',rating:'BUY',target:390,note:'Upstream cost structure among lowest globally. FCF yield 8.2%.'},{firm:'Arqaam Capital',rating:'SELL',target:310,note:'Energy transition risk underpriced.'}],
  ...
  { t:'MDCR', n:'MediCore Group',     s:'Healthcare',    ip:198.40, pe0:22.1, div:1.2, b:.8,  yr:2005, emp:38000,  hq:'Boston',
    ...
    analysts:[{firm:'Leerink Partners',rating:'STRONG BUY',target:240,note:'Phase 3 data transformational if successful.'},{firm:'UBS Healthcare',rating:'BUY',target:215,note:'Defensive growth at reasonable valuation.'},{firm:'RBC Capital',rating:'HOLD',target:195,note:'Phase 3 binary risk in 6 months.'}],
  ...
  { t:'UTLS', n:'Utility Systems',    s:'Utilities',     ip:58.40,  pe0:14.2, div:4.2, b:.5,  yr:1950, emp:12000,  hq:'Chicago',
    ...
    analysts:[{firm:'Mizuho',rating:'BUY',target:63,note:'4.2% yield with regulatory moat. Safe haven in volatile markets.'},{firm:'KeyBanc',rating:'HOLD',target:59,note:'Fair value. Yield attractive but growth is zero.'}],
  ...
  { t:'TLCM', n:'TeleCom Europe',     s:'Telecom',       ip:88.60,  pe0:13.5, div:4.5, b:.6,  yr:1985, emp:48000,  hq:'Frankfurt',
    ...
    analysts:[{firm:'Berenberg',rating:'HOLD',target:92,note:'5G rollout complete. 4.5% dividend is the thesis.'},{firm:'Exane BNP',rating:'SELL',target:78,note:'Spectrum auction costs incoming. Dividend at risk.'}],
  ...
  { t:'RLST', n:'RealEstate Trust',   s:'Real Estate',   ip:44.20,  pe0:12.8, div:3.8, b:.7,  yr:1995, emp:2800,   hq:'Dallas',
    ...
    analysts:[{firm:'Green Street',rating:'BUY',target:52,note:'Best-in-class logistics REIT. E-commerce structural demand.'},{firm:'Piper Sandler',rating:'HOLD',target:45,note:'Good REIT, full valuation.'}],
  ...
  { t:'EMTS', n:'Emerging Tech',      s:'Technology',    ip:28.40,  pe0:22.0, div:.2,  b:2.0, yr:2015, emp:6500,   hq:'Mumbai',
    ...
    analysts:[{firm:'Ambit Capital',rating:'STRONG BUY',target:40,note:'Best founder-led EM tech story we cover. TAM $45B.'},{firm:'CLSA',rating:'BUY',target:35,note:'Valuation elevated but growth trajectory justifies it.'}],
  ...
  { t:'AGRO', n:'AgroLatin Corp',     s:'Agriculture',   ip:42.18,  pe0:13.2, div:2.5, b:1.1, yr:1975, emp:18000,  hq:'São Paulo',
    ...
    analysts:[{firm:'Bradesco BBI',rating:'BUY',target:52,note:'Consistent dividend payer. Farmland as hard asset.'},{firm:'BTG Pactual',rating:'HOLD',target:44,note:'Commodity price risk. Good company but timing matters.'}],
