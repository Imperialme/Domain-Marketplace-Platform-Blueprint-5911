...
export const GEO_EVENTS = [
  ...
  { ico:'🛢️', ti:'Oil Cartel Emergency Supply Cut', bo:'Cartel announces 2.4M barrel/day reduction effective immediately. Energy stocks surge; inflation risk elevated.', region:'Middle East', impact:'positive', affects:{oil:1.12,energy:1.08} },
  ...
  { ico:'🏘️', ti:'Global Real Estate Bubble Warning', bo:'Global Monetary Council flags coordinated real estate overvaluation. Property prices 38% above fair value in 12 major cities. Correction risk acute.', region:'Global', impact:'negative', affects:{realestate:0.88,bonds:1.04} },
  ...
  { ico:'🦠', ti:'Antibiotic Resistance Crisis', bo:'The Global Health Assembly declares a post-antibiotic era. 6 common pathogens now fully drug resistant. Emergency biotech funding surge.', region:'Global', impact:'negative', affects:{biotech:1.12,health:0.90} },
